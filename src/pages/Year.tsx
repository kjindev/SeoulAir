import COChart from "../yearChart/COChart";
import NO2Chart from "../yearChart/NO2Chart";
import O3Chart from "../yearChart/O3Chart";
import PM10Chart from "../yearChart/PM10Chart";
import PM25Chart from "../yearChart/PM25Chart";
import RadarChart from "../yearChart/RadarChart";
    ...
    <div>
      ...
      <div className="w-[85vw] flex flex-col justify-center items-center">
        <div className="w-[90%] flex flex-col lg:flex-row justify-between items-center">
          <div className="w-[100%] lg:w-[65%] lg:h-[45vh] flex justify-center mb-5 bg-white rounded-xl">
            <PM10Chart />
          </div>
          <div className="w-[100%] md:w-[50%] lg:w-[33%] lg:h-[45vh] lg:ml-5 lg:self-center mb-5 bg-white rounded-xl">
            <RadarChart />
          </div>
        </div>
        <div className="w-[90%] flex flex-col lg:flex-row justify-between items-center">
